  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                          <h5>Daftar Akun</h5>
                            <a href="<?= base_url('/user/create') ?>" class="btn btn-success mb-3">
                                        ...
                                        <?php $no = 1; foreach ($users as $u): ?>
                                            <tr>
                                                ...
                                                <td style="text-align:center;">
                                                    <a href="<?= base_url('/user/edit/' . $u['id']) ?>" class="btn btn-warning btn-sm">
                                                        <span class="fa fa-edit"></span>
                                                    </a>
                                                    <a href="<?= base_url('/user/delete/' . $u['id']) ?>" class="btn btn-danger btn-sm"
      ...
      <footer class="app-footer">
        <!--begin::To the end-->
        <div class="float-end d-none d-sm-inline">Muhammad Farhan 23.0504.0064</div>
        <!--end::To the end-->
        <!--begin::Copyright-->
        <strong>
...
<style>
    /* Pusatkan logo ke tengah layar */
    .logo-wrapper {
    display: flex;
    justify-content: center;
    align-items: center;
    height: 20vh; /* penuh layar */
    background-color:rgb(255, 255, 255); /* sesuaikan dengan tema */
    }
    ...
    animation: shineAnim 3s infinite ease-in-out;
    }
    .logo-description {
    margin-top: 16px;
    font-size: 16px;
